...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Image handling - Create an empty JSON array
    $images = json_encode([]);
    ...
    if (empty($title) || empty($description) || $price <= 0 || empty($property_type) || empty($address_line1) || empty($city) || $agent_id <= 0) {
        ...
        try {
            // SQL query aligned with the actual properties table structure
            $query = "INSERT INTO properties (
                        agent_id, title, description, images, price, property_type, status,
                        address_line1, city, state, postal_code, country,
                        bedrooms, bathrooms, living_area, year_built,
                        has_parking, parking_spaces, has_garden,
            ...
            $success = "Property added successfully! Property ID: $property_id";
            ...
            <div class="content-card">
                <div class="card-body p-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control form-control-custom" name="price" step="0.01" min="0" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control form-control-custom" name="bedrooms" min="0" value="0">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Bathrooms</label>
                                    <input type="number" class="form-control form-control-custom" name="bathrooms" min="0" value="0">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Living Area (m²)</label>
                                    <input type="number" class="form-control form-control-custom" name="living_area" min="0" value="0" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Year Built</label>
                                    <input type="number" class="form-control form-control-custom" name="year_built" min="1800" max="<?= date('Y') + 5 ?>" value="0">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control form-control-custom" name="parking_spaces" min="0" value="0">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        After adding the property, you can upload images on the property edit page.
                    </div>
